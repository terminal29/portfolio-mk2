...
function App() {
  ...
  }, [messageIndex, heroWordRefs, heroTextWidth]);
          ...
          <div className={css(styles.foldContainer)}>
            <div className={css(styles.heroContainer)}>
              <div className={css(styles.heroText)}>
                ...
                <div
                  className={css([
                    styles.heroTextSpacing,
                    dynStyles.heroTextDyn
                  ])}
          ...
          <div className={css(styles.mainContentContainer)}>
            ...
            >
              <div className={css(styles.contentContainer)} id="about">
                ...
                <div
                  className={css([styles.contentContent, styles.aboutContent])}
                >
                  <p>
                    ...
                    . I have been developing software for PC, Web, and Mobile
                    for over 6 years with{" "}
                    <span className={css(styles.highlightColour)}>
                ...
                <div className={css(styles.contentContent)}>
                  <div className={css(styles.projectContainer)}>
                    ...
                    <div className={css(styles.projectDescription)}>
                      A driver for SteamVR to allow the 3D tracked Massless Pen
                      to be used with the Oculus Rift, Oculus Quest, HTC Vive,
                      and Valve Index headsets on the SteamVR platform.
                    </div>
                    <a
                  ...
                  <div className={css(styles.projectContainer)}>
                    ...
                    <div className={css(styles.projectDescription)}>
                      A work-in-progress calendar/note taking app built using
                      React Native.
                    </div>
                    <a
                      className={css(styles.projectLink)}
                  ...
                  <div className={css(styles.projectContainer)}>
                    ...
                    <div className={css(styles.projectDescription)}>
                      A small tool for displaying the currently connected
                      devices to your SteamVR/OpenVR system.
                    </div>
                    <a
                      className={css(styles.projectLink)}
                      href={
                        "https://github.com/terminal29/OpenVR-Device-Viewer"
                      }
                    >
                      <div style={{ display: "inline-block", margin: 10 }}>
                        View Project on{" "}
